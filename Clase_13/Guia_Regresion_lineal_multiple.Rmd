...
3) Existe homogeneidad d evarianzas.
...
- ¿Qué representa los diferentes estimadores Beta?. 
...
Evalue los supuestos de multicolinealidad, normalidad y homogeneidad de varianzas.
...
Debido al problema de multicolinealidad detectado en el ejericcio anterior se puede decidir en eliminar una de las variables predictoras correlacionadas. En este caso y de forma arbitaria escogeremos la variables **Pred_X3**, pero note que podríamos estar generando un problema de cusalidad por variables omitidas. En las próximas clases veremos como resolver esto usando Análisis de Componentes Principales.
