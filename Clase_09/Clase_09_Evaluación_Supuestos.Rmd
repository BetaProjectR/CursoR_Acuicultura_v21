...
- Medidas repetidas en un mismo individuo (antes y despues de un tratamiento).  
...
*En la práctica alguna heterogeneidad es permitida, particularmente con n > 30.*
...
|  **n** | Cola izq.| Cola der.| $\alpha_{Empirica}$  |
|:-------------|:------------------|:------------------|:------------------|
| **5** | 0,20 | 0,26 | 0,46 |
| **10** | 0,24 | 0,28 | 0,52 |
| **20** | 0,23 | 0,26 | 0,49 |
...
*En la práctica apróximadamente normal es suficiente, particularmente con n > 30.*
...
**¿Para qué sirven?**  
Para someter a prueba los supuestos de muchos análisis paramétricos como ANOVA, ANCOVA o REGRESION. 
...
Se recomienda simpre tratar los ANOVA y similares como casos particulares de un modelo lineal 
```{r, echo=TRUE}
