---
title: "Guía Evaluación de supuestos análisis paramétricos"
...
**Homocedasticidad**  
En el caso de comparación de dos o más muestras estan deben provenir de poblaciones con la misma varianza.
...
|  **Librería** | **Función**      |
|:-------------|:------------------|
| **car** | Libería de acompañamiento al libro de J. Fox and S. Weisberg, An R Companion to Applied Regression, Third Edition, Sage, 2019 |
| **lmtest** | Libería que permite realizar análisis de diagnósticos de mopdelos lineales |
...
**4.-** : Agusta modelos lineales con la formula variable Respuesta ~ Variable/s expllicativas **lm()**
...
En el primer bloque de códigos o **chunk** configure los comandos de la siguiente manera **_knitr::opts_chunk$set(echo = TRUE)_** y cargue las librerías  **readxl**, **car**, **lmtest**, **dplyr**, **ggplot2** y **knitr**.
...
### **Ejercicio 3.** Estudio de caso cepas de Tilapia.

En el siguiente ejercicio se desea evaluar si los datos de crecimiento de 3 cepas de Tilapia cumplen con los supustos del análisis de varianza. 

a) Importe el set de datos **tilapia_cepas** y realice un análisis exploratorio de datos.
...
c) Realice una evaluación de supuestos mediante métodos basados en análisis de residuales.
...
a) Importe el set de datos **Harvey_dat** y realice un análisis exploratorio de datos.
...
En el siguiente ejericio debe evaluar si se cumplen los supuestos para realizar un análisis de correlación entre las variables peso del cuerpo (weight) y Peso de filete (fillet) obtenidos de una planta de proceso de truchas.

a) Importe el set de datos **trucha** y realice un análisis exploratorio de datos.
...
c) ¿Qué otro supuesto tienen los análisis de correlación paramétricos además de independencia y normalidad?
