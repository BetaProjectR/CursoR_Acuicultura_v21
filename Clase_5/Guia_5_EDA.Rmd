...
El archivo **"genotipos.xlsx"** contiene el registro de genotipos y peso de cosecha de 1000 salmones de un programa de mejora genética.

**a)** Elabore un objeto denominado "datos" e importe el set de datos **genotipos.xslx** usando la función **read_excel()** de la librería **readxl**. Observe los datos con la función **summary()** y **str**. Note que las variables **id** y **genotipos** están codificadas como **character** y el **weight** como **numeric**
...
El archivo **"tilapia.xlsx"** contiene el registro de pesosde 1000 tilapias de un experimento de alimentación con 6 dietas diferentes.
