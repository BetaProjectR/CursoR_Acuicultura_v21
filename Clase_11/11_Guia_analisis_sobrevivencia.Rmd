...
subtitle: 'Curso Introducción en Análisis de datos con R para la acuicultura'
author:
...
**1**. - Realizar pruebas paramétricas y no paramétricas.
...
El oxígeno es un indicador importante de los procesos biológicos en el océano y por tanto es una variable que se requiere monitorear de forma precisa en diversos contexto de la acuicultura incluyendo el monitoreo de sistemas de cultivo de peces. 
